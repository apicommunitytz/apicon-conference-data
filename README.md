...
| `https://raw.githubusercontent.com/apicommunitytz/apicon-conference-data/main/2026/conference.json` | **Raw file**. Plain JSON over HTTPS. This is what `fetch` will request. |
